...
Ext.ux.plugins.SortableDataView = function(config) {
	Ext.apply(this, config || {}, {
		dragCls : 'x-view-sortable-drag',
		viewDragCls : 'x-view-sortable-dragging'
	});
	Ext.ux.plugins.SortableDataView.superclass.constructor.call(this);
};

Ext.extend(Ext.ux.plugins.SortableDataView, Ext.util.Observable, {
