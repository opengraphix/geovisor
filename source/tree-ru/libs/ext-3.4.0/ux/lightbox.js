    ...
    return {
        ...
        initEvents: function() {
            ...
            els.navPrev.on('click', function(ev) {
                ev.preventDefault();
                activeImage == 0 ? this.setImage(images.length - 1) : this.setImage(activeImage - 1); /* DR */
                //this.setImage(activeImage - 1);                                                     **** Original ****
            }, this);

            els.navNext.on('click', function(ev) {
                ev.preventDefault();
                activeImage == images.length - 1 ? this.setImage(0) : this.setImage(activeImage + 1); /* DR */
                //this.setImage(activeImage + 1);                                                     **** Original ****
            }, this);
        },
        ...
        updateNav: function(){
            ...
            //if (activeImage > 0)                                                                   **** Original ****
                els.navPrev.show();

            // if not last image in set, display next image button
            //if (activeImage < (images.length - 1))                                                 **** Original ****
                els.navNext.show();
        },
